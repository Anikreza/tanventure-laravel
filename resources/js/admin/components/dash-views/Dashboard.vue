    ...
    <v-layout wrap>
      ...
      >
        <material-chart-card
            ...
            type="Line"
        >
          <h4 class="title font-weight-light">{{ $t('Pages.Dashboard.company_register_history') }}</h4>
          <p class="category d-inline-flex font-weight-light">
            ...
            {{ $t('Pages.Dashboard.registration_increase') }}
          </p>
      ...
      >
        <material-chart-card
            ...
            type="Line"
        >
          <h3 class="title font-weight-light">{{ $t('Pages.Dashboard.completed_task') }}</h3>
          <p class="category d-inline-flex font-weight-light">
            {{ $t('Pages.Dashboard.latest_update') }}
          </p>
          ...
          <template slot="actions">
            ...
            <span class="caption grey--text font-weight-light">
               {{ $t('Pages.Dashboard.campaign_sent', { time: `10 ${$t('Common.minute')}` }) }}
            </span>
          </template>
        </material-chart-card>
      </v-flex>
      ...
      >
        <material-stats-card
            ...
            :sub-text="$t('Pages.Dashboard.last_()_hours', {time: 24})"
        />
      </v-flex>
      <v-flex
          sm6
      ...
      >
        <material-stats-card
            ...
            :sub-text="$t('Pages.Dashboard.companies_joined', {'company': 5,'time': `24 ${$t('Common.hour')}`})"
        />
      </v-flex>
      <v-flex
          sm6
      ...
      >
        <material-stats-card
            ...
            :sub-text="$t('Pages.Dashboard.with_supported_skill', {'skill': 5})"
        />
      </v-flex>
      <v-flex
          sm6
      ...
      >
        <material-stats-card
            ...
            :title="$t('Common.screen_test')"
            value="+245"
            sub-icon="mdi-update"
            :sub-text="$t('Pages.Dashboard.average_screen_test_weekly', {avg: 5})"
        />
      </v-flex>
      <v-flex
          md12
      ...
      >
        <SimpleTable :color="$store.state.app.color"
                     :title="$t('Pages.Dashboard.screening_summary')"
                     :sub-title="$t('Pages.Dashboard.last_screening', {time: '20th Jun, 2020'})"/>
      </v-flex>
      <v-flex
          md12
          lg6
