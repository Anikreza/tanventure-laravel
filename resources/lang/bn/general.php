...
return [
    ...
    "subscribeFoot" => "ট্যানের সংগে থাকতে, ও নতুন পোস্টের খবর জানতে!",
...
//    'anotherStory'=>'পৃথিবীর বন পাহাড় এবং সমুদ্রের টানে মাতাল এক ছোকরা!',
    ...
    "services" => "সার্ভিস",
    "search" => "খোজ...",
    "nothing" => "কিছু খুজে পাওয়া যায়নি, দুঃখিত!!!",
    "tryOther" => "ব্লগপেজ, এক্সপ্লোর সেকশনগুলো ভালোভাবে খুজে দেখতে পারেন, অথবা সাম্পর্কিক কিছু লিখে আবার খুজতে পারেন!",
    "mostRead" => "সবচেয়ে বেশীবার পড়া আর্টিকেল",
    "featured" => "ফিচার আর্টিকেল",
    "yourMail" => "ইমেইল",
